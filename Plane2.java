...
/**
 * Created by NALAYAK on 3/24/2018.
 */
...
public class Plane2 extends Plane {
    ...
    public Plane2(Context context) {
        ...
        plane[5] = BitmapFactory.decodeResource(context.getResources(), R.drawable.plane2_5);
        plane[6] = BitmapFactory.decodeResource(context.getResources(), R.drawable.plane2_6);
        plane[7] = BitmapFactory.decodeResource(context.getResources(), R.drawable.plane2_7);
        plane[8] = BitmapFactory.decodeResource(context.getResources(), R.drawable.plane2_8);
        plane[9] = BitmapFactory.decodeResource(context.getResources(), R.drawable.plane2_9);
        plane[4] = BitmapFactory.decodeResource(context.getResources(), R.drawable.plane2_10);
